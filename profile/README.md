...
- **FreedInk** - anonymous, collective blogging gated by zero-knowledge (Semaphore) proofs: members write, edit, and vote to publish as an unlinkable group. _AGPL-3.0_
