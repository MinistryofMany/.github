...
- **Discreetly** ([discreetly.chat](https://discreetly.chat)) - anonymous, federated zero-knowledge group chat: room access is gated by a structured Minister badge policy, and messaging is secured by client-side RLN (rate-limiting nullifier) proofs.
